...
if (isset($_POST['submit'])) {
  ...
  if ($check>0) {
    ...
    try {
      ...
      $mail->SMTPAuth = true;
      $mail->Username = 'kkoriya1111@gmail.com'; // Gmail address which you want to use as SMTP server
      $mail->Password = 'kk1111kk'; // Gmail address Password
      $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
      $mail->Port = '587';
      $mail->setFrom('kkoriya1111@gmail.com'); // Gmail address which you used as SMTP server
